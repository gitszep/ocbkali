...
const Footer = () => {
  ...
  if (state.succeeded) {
    return null; // Nie renderuje nic, gdy stan succeeded jest prawdziwy
  }
      ...
      <div className='max-w-[1400px] mx-auto grid grid-cols-2 md:grid-cols-6 border-b-2 border-gray-600 py-8 px-4'>
        ...
        <div className='col-span-2 py-8 md:pt-2'>
          ...
          <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row'>
            ...
            <button type='submit' className='p-2 mb-4 rounded-md'>Subscribe</button>
          </form>
        </div>
      </div>

      <div className='flex flex-col max-w-[1400px] px-2 py-4 mx-auto justify-between sm:flex-row text-center text-gray-500'>
        <p className='py-4'>2024 OCBSiR All rights reserved  </p>
        <p className='text-sm py-4'>Created by Jarek Szepelak  </p>
